...
public class OrderServiceTest {
    ...
    void testCreateOrderIfAlreadyExists() {
        ...
        assertNull(orderRepository.createOrder(order));
    ...
    void testUpdateStatusInvalidOrderId() {
        doReturn(null).when(orderRepository).findById("freya");

        assertThrows(IllegalArgumentException.class, () ->
          orderService.updateStatus("freya", OrderStatus.SUCCESS.getValue()));
    ...
    void testFindByIdIfIdNotFound() {
        doReturn(null).when(orderRepository).findById("freya");
        assertNull(orderService.findById("freya"));
    }
